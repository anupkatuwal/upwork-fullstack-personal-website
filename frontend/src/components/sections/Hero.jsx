        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 360px", gap:64, alignItems:"center" }}>
          ...
          <div style={{ animation:"fadeUp 0.8s ease both" }}>
            ...
            <h1 style={{
              ...
              <GlitchText text={profile?.name?.split(" ")[0] || "Alex"} />
              <br />
              <span style={{ color:"var(--text-2)", fontWeight:300 }}>
                {profile?.name?.split(" ")[1] || "Rivera"}
              </span>
            </h1>
            ...
            <p style={{
              ...
              {profile?.summary || "Master's graduate in Computer Information Systems. Building intelligent systems at the intersection of NLP, data analytics, and fairness-aware machine learning."}
            </p>
            ...
            <div style={{ display:"flex", gap:16, flexWrap:"wrap", marginBottom:48 }}>
              ...
              <a href={profile?.github || "https://github.com/alex-rivera-dev"} target="_blank" rel="noreferrer" className="btn btn-outline">
          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", animation:"fadeUp 0.8s ease 0.2s both" }}>
            ...
            <div style={{ display:"flex", flexWrap:"wrap", gap:8, justifyContent:"center", marginTop:32 }}>
              {["BERT", "Python", "NLP", "PyTorch", "Fairness AI"].map(t => (
